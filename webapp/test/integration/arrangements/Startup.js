sap.ui.define([
	"sap/ui/test/Opa5",
	"opensap/salesOrderViewer/SalesOrderViewer/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("opensap.salesOrderViewer.SalesOrderViewer.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "opensap.salesOrderViewer.SalesOrderViewer",
					async: true
				},
				hash: oOptions.hash,
