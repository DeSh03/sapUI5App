sap.ui.define([
	...
	return BaseController.extend("opensap.salesOrderViewer.SalesOrderViewer.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "opensap.salesOrderViewer.SalesOrderViewer.view.ViewSettingsDialog",
					controller: this
